...
with open(r'C:\Users\ioannis\Documents\My Samples\us_counties.topo.json', 'r') as f:
    get_id = json.load(f)
...
with open(r'C:\Users\ioannis\Documents\My Samples\us_counties.topo.json', 'w') as f:
    json.dump(get_id, f)
